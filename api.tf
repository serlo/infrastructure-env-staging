...
module "api_redis" {
  source = "github.com/serlo/infrastructure-modules-shared.git//redis?ref=v12.0.0"
...
module "api" {
  source = "github.com/serlo/infrastructure-modules-api.git//?ref=v9.1.0"
