...
module "hydra" {
  source = "github.com/serlo/infrastructure-modules-shared.git//hydra?ref=v15.2.0"
...
module "kratos" {
  source = "github.com/serlo/infrastructure-modules-shared.git//kratos?ref=v15.2.0"
...
module "kratos-import-users" {
  source = "github.com/serlo/infrastructure-modules-shared.git//kratos-import-users?ref=v15.2.0"
