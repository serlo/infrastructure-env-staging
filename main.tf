...
locals {
  ...
  athene2_httpd_image               = "eu.gcr.io/serlo-shared/serlo-org-httpd:2.0.0"
  athene2_php_image                 = "eu.gcr.io/serlo-shared/serlo-org-php:2.0.0"
  ...
  editor-renderer_image        = "eu.gcr.io/serlo-shared/serlo-org-editor-renderer:2.0.0"
